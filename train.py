...
from infiniattention.data_utils import get_lm_corpus
from infiniattention.infiniattn_transformer import InfiniAttentionLM
from infiniattention.utils.exp_utils import create_exp_dir
from infiniattention.utils.data_parallel import BalancedDataParallel
...
logging = create_exp_dir(
    args.work_dir,
    scripts_to_save=["train.py", "infiniattn_transformer.py"],
    debug=args.debug,
)
...
va_iter = corpus.get_iterator(
    "valid", eval_batch_size, args.eval_tgt_len, device=device
)
    ...
    for batch, (data, target, seq_len) in enumerate(train_iter):
        ...
        if args.batch_chunk > 1:
            ...
            for i in range(args.batch_chunk):
                ...
                ret = para_model(data_i, target_i)
                loss = ret
